		...
		<table>
			...
			<c:forEach var="category" items="${categoryList}">
				<tr>
					...
					<th><a href="category-delete?idCategory=${category.idCategory}" onclick="if(!confirm('Delete this category?')) return false">delete</a></th>
				</tr>
			</c:forEach>
		</table>
	</div>
              ...
              <div class="card-header">
                ...
                <div class="card-tools">
                  <form class="btn-group">
                    <button class="btn btn-outline-success" onclick="saveOrder()">
...
<!-- Include jQuery and jQuery UI Sortable libraries -->
...
<script>
function saveOrder() {
  var rows = $("#sort-list tr");
  var categoryOrder = [];

  rows.each(function() {
    var displayOrder = $(this).find("td:first-child span").text().trim();
    categoryOrder.push(displayOrder);
  });
