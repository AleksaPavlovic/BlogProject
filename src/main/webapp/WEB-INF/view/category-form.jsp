	                 ...
	                 <c:forEach var="category" items="${categoryList}">  
	                    <tr>
	                      ...
	                      <td class="text-center">
	                        <div class="btn-group">
	                          <a href="category-update?idCategory=${category.idCategory}" class="btn btn-info">
	                            <i class="fas fa-edit"></i>
	                          </a>
	                          <a href="category-delete?idCategory=${category.idCategory}" onclick="if(!confirm('If you proceed all posts in this category will be deleted. Delete this category?')) return false" class="btn btn-info">
